...
const Hero = () => {
  ...
  return (
    <section className={`relative h-[100vh] overflow-hidden flex items-center text-white text-lg ${ubuntuMono.className}`}>
      ...
      />
      <div className="w-8 flex md:flex-col gap-3 items-center absolute bottom-12 ml-20 md:right-24 z-30">
        <div className="border-l-2 border-blue-500 h-20 hidden md:block"></div>
