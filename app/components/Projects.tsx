...
const Projects = () => {
  const projects = [
    ...
    { title: 'User portal for insurance companies', image: '/Insurance.png', description: 'A portal that helps insurance customers manage their insurance easily from anywhere - Web App (Next.js)', link: 'https://github.com/Tamiru-Alemnew/Insurance-company-system' },
