...
const Projects = () => {
  const projects = [
    ...
    { title: 'Task Manager API', image: 'https://go.dev/blog/go-brand/Go-Logo/SVG/Go-Logo_Blue.svg', description: 'A back-end API project using golang and gin', link: 'https://github.com/abe16s/Task-Manager-API-Final' },
  ];
